...
async def cmd_start(message: Message, state: FSMContext):
    ...
    if user:
        ...
        # is_admin = user[8]
        is_superadmin = config.ADMIN == user[1]
        is_admin = user[8]
        
        if is_superadmin and is_admin:
            ...
            await message.answer(
                ...
                "<b>Admin</b> panelga o'tish uchun /admin_panel buyrug'ini yuboring.",
        ...
        await state.set_state(GetPhoneNumber.wait_phone_for_reg)


@router.message(F.text.regexp(r'^998\d{9}$'), GetPhoneNumber.wait_phone_for_reg)
