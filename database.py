...
class Database:
    ...
    def _insert_initial_data(self, cursor):
        ...
        if cursor.fetchone()[0] == 0:
            groups = [
                ...
                (4, config.GROUP_LINKS[3], 'Sibirski')
            ]
            cursor.executemany(
    ...
    def get_filial_task_statistics(self, date_obj):
        """
        Har bir filial bo'yicha kunlik vazifalar statistikasi
